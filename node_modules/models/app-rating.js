...
var debug = require('debug')('appreports:app-ratings');
...
schema.statics.getDetails = function(storeId, date, callback) {
  debug('getting details', storeId, date);
  this.aggregate([
